	...
	class Recommended_Plugins extends Recommended {
		...
		public function admin_menu() {
			...
			$this->sub_menu = add_submenu_page(
				'',       // Ex. my-reading-time-lite-settings /  edit.php?post_type=page .
				__( 'Recommended', 'my-reading-time-lite' ),
				__( 'Recommended', 'my-reading-time-lite' ),
				'manage_options',
				'my-reading-time-lite-recommended-plugins',
