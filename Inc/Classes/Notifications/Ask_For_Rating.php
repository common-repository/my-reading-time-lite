	...
	class Ask_For_Rating extends Notice {
		...
		public function notice_content() {
			printf(
				...
				__( 'A positive rating will keep us motivated to continue supporting and improving this free plugin, and will help spread its popularity.<br> Your help is greatly appreciated!', 'my-reading-time-lite' )
			);
		}
